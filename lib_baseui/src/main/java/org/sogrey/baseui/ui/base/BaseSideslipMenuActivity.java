...
import org.sogrey.baseui.ui.base.sideslipmenu.SideslipMenu;
import org.sogrey.baseui.ui.base.sideslipmenu.SideslipMenuItem;
...
public abstract class BaseSideslipMenuActivity extends BaseActivity {
    ...
    private void setSideslipMenu() {
        ...
        mSideslipMenu.addMenuItems(getLeftMenuItems(), SideslipMenu.DisableDirection.DIRECTION_LEFT);
        mSideslipMenu.addMenuItems(getRightMenuItems(), SideslipMenu.DisableDirection.DIRECTION_RIGHT);
     ...
     * 菜单点击事件
     */
    private SideslipMenu.OnMenuListener _listener=new SideslipMenu.OnMenuListener() {
        @Override
